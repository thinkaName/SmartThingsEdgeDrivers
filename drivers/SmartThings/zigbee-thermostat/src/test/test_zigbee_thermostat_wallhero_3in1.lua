...
test.register_message_test(
    "Reported on status should be handled: off ep 1",
    {
      {
        channel = "zigbee",
        direction = "receive",
...
test.register_message_test(
    "FanControl fan mode reports are handled",
    {
      {
        channel = "zigbee",
        direction = "receive",
...
test.register_message_test(
    "Reported on status should be handled: on ep 2",
    {
      ...
      },
      {
        channel = "capability",
        direction = "send",
        message = mock_simple_device:generate_test_message("heat",  capabilities.switch.switch.on())
      }
    }
)

test.register_message_test(
    "Reported on status should be handled: off ep 2",
    {
      {
        channel = "zigbee",
        direction = "receive",
      ...
      },
      {
        channel = "capability",
        direction = "send",
        message = mock_simple_device:generate_test_message("heat",  capabilities.switch.switch.off())
      }
    }
)
...
test.register_message_test(
    "Reported on status should be handled: on ep 3",
    {
      ...
      },
      {
        channel = "capability",
        direction = "send",
        message = mock_simple_device:generate_test_message("fan",  capabilities.switch.switch.on())
      }
    }
)

test.register_message_test(
    "Reported on status should be handled: off ep 3",
    {
      {
        channel = "zigbee",
        direction = "receive",
      ...
      },
      {
        channel = "capability",
        direction = "send",
        message = mock_simple_device:generate_test_message("fan",  capabilities.switch.switch.off())
      }
    }
)
