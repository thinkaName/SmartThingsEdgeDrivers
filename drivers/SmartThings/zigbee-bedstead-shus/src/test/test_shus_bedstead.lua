...
local custom_capabilities = require "shus-bedstead/custom_capabilities"

local shus_bedstead_profile_def = t_utils.get_profile_definition("shus-smart-bedstead.yml")
